      ...
      return Column(
          children: <Widget>[
            ListTile(
              ...
              onTap: () {model.onUpdateWhiteList(WhiteList.incomplete); Navigator.pop(context);},
            ),
            ListTile(
              leading: checkSelect(model, WhiteList.complete),
              title: Text('Complete'),
              onTap: () {model.onUpdateWhiteList(WhiteList.complete); Navigator.pop(context);},
            ),
            ListTile(
              leading: checkSelect(model, WhiteList.all),
              title: Text('All'),
              onTap: () {model.onUpdateWhiteList(WhiteList.all); Navigator.pop(context);},
            )
          ],
      );});
  }
    ...
    Widget build(BuildContext context) {
      return StoreConnector<AppState, ViewModel>(
        ...
        body: RefreshIndicator(
         ...
         floatingActionButtonLocation: FloatingActionButtonLocation.centerDocked,
          floatingActionButton: Builder(
              ...
              onPressed: () => _createNewTask(context, model),
              child: new Icon(Icons.add),
              heroTag: 'Add',
              ),
            ), 
        ...
        child: new Row(
          ...
          children: <Widget>[
                IconButton(icon: Icon(Icons.menu), onPressed: () => _whiteListControl(context, model),),
